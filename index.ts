...
import * as modules from "./session-modules.js";

type AssistantSpeedTracker = ReturnType<typeof modules.createAssistantSpeedTracker>;
type WorkingLoaderController = ReturnType<typeof modules.createWorkingLoaderController>;
type WorkingStateForAssistantMessage = typeof modules.workingStateForAssistantMessage;
type SetAssistantUpdateRenderRequester = typeof modules.setAssistantUpdateRenderRequester;
...
export default function (pi: ExtensionAPI) {
	...
	pi.on("session_start", async (_event, ctx) => {
		...
		sessionUi.setEditorComponent((tui, theme, kb) => {
			...
			if (renderDebug) installRenderFrameDebug(tui as any);
